...
const Login = () => {
  ...
  const handleSubmit = async (event) => {
    ...
    // Check if travelmate user credentials are entered
    if (email === "travelmate@gmail.com" && password === "travelmate") {
      localStorage.setItem("username", "TravelMate");
      localStorage.setItem("userEmail", email);
      
      // Dispatch login event
      window.dispatchEvent(new CustomEvent('loginUpdate', {
        detail: { username: "TravelMate", email }
      }));
      
      swal("Success", "Logged in as TravelMate user!", "success");
